/**
 * Clean all existing content and seed only the two new top articles
 */

import { mutation } from './_generated/server';
import { v } from 'convex/values';

export const cleanAndSeedArticles = mutation({
  handler: async (ctx) => {
    ...
    // Only add the two new articles we want
    const articles = [
      {
