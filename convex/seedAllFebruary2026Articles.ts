/**
 * Seed all February 2026 articles with proper niche mapping
 */

import { mutation } from './_generated/server';
import { v } from 'convex/values';

export const seedAllFebruary2026Articles = mutation({
  handler: async (ctx) => {
...
*Resident Evil: Requiem* isn't just a game; it's an endurance test. It challenges your nerves, your planning, and your aim. For anyone following the **biggest new game releases February 2026**, this is the one that will be talked about for years. Turn off the lights, put on your headset, and prepare for a requiem you won't soon forget.`,
        wordCount: 965,
...
In *Nioh 3*, the Yokai Shift mechanic has been completely overhauled. Players now have more control over their demonic forms, with a customizable 'Spirit Core' system that allows for hybrid builds. You can blend the speed of the Feral form with the raw power of the Brute, creating a playstyle that is uniquely yours. 
...
One of the reasons *Nioh 3* is topping the **upcoming video games 2026 releases** list is its 'Abyss Mode' successor: the **Yokai Expeditions**. These are 4-player co-op raids that offer the best loot in the game. Team Ninja has promised over 200 hours of content for those who enjoy the 'grind' for perfect gear stats. 

### Verdict: The Soul of Action

For those who find traditional *Souls* games too slow, *Nioh 3* is the answer. It is fast, technical, and immensely rewarding. Among all **upcoming video games 2026 releases**, this is the one that will test your reflexes and your patience. Prepare to die, prepare to learn, and eventually, prepare to conquer.`,
        wordCount: 955,
    ...
    for (const article of articles) {
      ...
      if (!existing) {
        ...
        if (article.contentType === 'security') {
          nicheId = '2'; // Security Niche
        } else if (article.contentType === 'gaming') {
          nicheId = '3'; // Gaming Niche
        } else {
          // Default to tech for other types
          nicheId = '1'; // Tech Niche
        }
