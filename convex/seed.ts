...
const SEED_ARTICLES = [
  {
    title: "The Trillion-Dollar Synergy: Why the xAI and SpaceX Merger is the Future of Global Compute",
    ...
    body: "The tech landscape in February 2026 is being reshaped by a single, gravity-defying headline: the formal merger talks between Elon Musk's xAI and SpaceX. Unifying orbital infrastructure with generative intelligence could redefine global compute. [Full 800+ word text here]",
  ...
  handler: async (ctx) => {
    ...
    for (const row of SEED_ARTICLES) {
      ...
      const contentId = await ctx.db.insert("content", {
        ...
        contentType: contentFields.contentType,
