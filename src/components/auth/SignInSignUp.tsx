                  ...
                  appearance={{
                    elements: {
                      ...
                      socialButtonsBlockButton:
                        "!bg-white/10 !text-white !border !border-white/20 hover:!bg-white/20 !rounded-lg !font-semibold !transition-all",
                      formButtonPrimary:
                        "!bg-gradient-to-r !from-nexus-cyan !to-blue-500 !text-white !rounded-lg !font-semibold hover:!shadow-lg hover:!shadow-nexus-cyan/25 !transition-all",
                      formFieldInput:
                        "!bg-white/5 !border !border-white/20 !text-white !rounded-lg focus:!border-nexus-cyan !transition-all",
                      formFieldLabel: "!text-gray-300 !text-sm !mb-1",
                      footerActionLink: "!text-nexus-cyan hover:!text-blue-400",
                      dividerLine: "!bg-white/20",
                      dividerText: "!text-gray-400",
                      identityPreviewText: "!text-white",
                      identityPreviewEditButton: "!text-nexus-cyan",
                      formFieldAction: "!text-nexus-cyan",
                      formResendCodeLink: "!text-nexus-cyan",
                      formHeaderTitle: "!text-white !font-bold",
                      formHeaderSubtitle: "!text-gray-400",
                      socialButtonsIconButton:
                        "!bg-white/10 !text-white !border !border-white/20 hover:!bg-white/20 !rounded-lg",
                    },
                  }}
                />
              ) : (
