...
export const mockArticles: Article[] = [
  ...
  },
  {
  ...
  },
    {
      ...
      metaTitle: 'Gmail Hack Wave 2026 — Every Gamer Needs 2FA Now',
    ...
    },
    {
      ...
      metaTitle: "Steam Account Hacked? Full Recovery Guide 2026 — What To Do Step By Step",
      metaDescription: "Steam account hacked? Here's exactly what to do in 2026. Complete recovery process, Steam support wait times, and how to secure your account from future takeovers in under 10 minutes.",
      impactLevel: 'high',
      isFeatured: true,
      securityScore: 95,
      viewCount: 340,
    ...
    },
    {
      ...
      metaTitle: "Minecraft Server Security Guide 2026 — DDoS Protection & Anti-Griefing",
...
<div style="border-left:4px solid #d97706;background:#fffbeb;padding:12px 16px;margin:20px 0;border-radius:0 6px 6px 0"><strong style="color:#d97706">⚡ Warning:</strong> If you lose access to your authenticator app without backup codes, account recovery takes days and may require proof of purchase. Always keep backup codes somewhere safe.</div>`,
    ...
    tags: ['Security Guide', 'Beginner', '2FA', 'Steam', 'Xbox', 'PlayStation', 'Epic Games', 'Authentication'],
      metaTitle: "How to Enable 2FA on Steam, Xbox, PlayStation & More — 2026 Guide",
