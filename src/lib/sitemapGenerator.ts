...
export function getBaseUrls(baseUrl: string = 'https://thegridnexus.com'): SitemapUrl[] {
  ...
  return [
    ...
    { loc: `${baseUrl}/tutorials`,        lastmod: today, changefreq: 'weekly',  priority: 0.7 },
    { loc: `${baseUrl}/reviews`,          lastmod: today, changefreq: 'weekly',  priority: 0.8 },
    { loc: `${baseUrl}/startups`,         lastmod: today, changefreq: 'daily',   priority: 0.7 },
    { loc: `${baseUrl}/tools`,            lastmod: today, changefreq: 'daily',   priority: 0.9 },
    { loc: `${baseUrl}/explore`,          lastmod: today, changefreq: 'daily',   priority: 0.85 },
    { loc: `${baseUrl}/ai-pulse`,         lastmod: today, changefreq: 'daily',   priority: 0.9 },
    { loc: `${baseUrl}/live-updates`,     lastmod: today, changefreq: 'daily',   priority: 0.8 },
    { loc: `${baseUrl}/roadmap`,          lastmod: today, changefreq: 'weekly',  priority: 0.6 },
    { loc: `${baseUrl}/security-profile`, lastmod: today, changefreq: 'weekly',  priority: 0.8 },
    { loc: `${baseUrl}/community-threats`,lastmod: today, changefreq: 'daily',   priority: 0.8 },
    { loc: `${baseUrl}/nexus-intersection`, lastmod: today, changefreq: 'weekly', priority: 0.7 },
    ...
    { loc: `${baseUrl}/editorial`,        lastmod: today, changefreq: 'monthly', priority: 0.4 },
    { loc: `${baseUrl}/disclosure`,       lastmod: today, changefreq: 'monthly', priority: 0.4 },
    { loc: `${baseUrl}/media`,            lastmod: today, changefreq: 'monthly', priority: 0.4 },
    { loc: `${baseUrl}/quality-guidelines`, lastmod: today, changefreq: 'monthly', priority: 0.4 },
    { loc: `${baseUrl}/content-policy`,   lastmod: today, changefreq: 'monthly', priority: 0.4 },
    { loc: `${baseUrl}/community-guidelines`, lastmod: today, changefreq: 'monthly', priority: 0.4 },
    { loc: `${baseUrl}/sitemap`,          lastmod: today, changefreq: 'monthly', priority: 0.2 },
    { loc: `${baseUrl}/security-score`,   lastmod: today, changefreq: 'monthly', priority: 0.7 },
    { loc: `${baseUrl}/breach-sim`,       lastmod: today, changefreq: 'monthly', priority: 0.7 },
    { loc: `${baseUrl}/forums`,           lastmod: today, changefreq: 'weekly',  priority: 0.6 },
    { loc: `${baseUrl}/api`,              lastmod: today, changefreq: 'monthly', priority: 0.5 },
    { loc: `${baseUrl}/mobile`,           lastmod: today, changefreq: 'monthly', priority: 0.5 },
    { loc: `${baseUrl}/podcasts`,         lastmod: today, changefreq: 'weekly',  priority: 0.6 },
    { loc: `${baseUrl}/learn/nexus-path`, lastmod: today, changefreq: 'weekly',  priority: 0.7 },
    { loc: `${baseUrl}/pulse/nexus-pulse`,lastmod: today, changefreq: 'daily',   priority: 0.8 },
    { loc: `${baseUrl}/nexus-studio`,     lastmod: today, changefreq: 'weekly',  priority: 0.7 },
    { loc: `${baseUrl}/gaming/security-guides`, lastmod: today, changefreq: 'weekly', priority: 0.7 },
  ];
}
